% La funcion simulador ejecuta simulacion numerica del modelo conservativo en el intervalo [0,100]. 
...
function dydt = ddefun(t, y, Z)
    ...
    dydt(3) = (1 - P.p) * P.alpha * y(2) - P.f2 * ylag2(3) - P.r2 * y(3) - P.mu * y(3);
    dydt(4) = P.p * P.alpha * y(2) - P.f1 * ylag1(4) - P.r1 * y(4) - P.mu * y(4);
...
function dydt = ddefun_pre1(t, y, Z)
    ...
    dydt(2) = P.beta * (1 - P.epsilon * P.phi) * y(1) * (P.sigma * y(3) + y(4)) - P.alpha * y(2) - P.mu * y(2);
    dydt(3) = (1 - P.p) * P.alpha * y(2) - P.r2 * y(3) - P.mu * y(3) - P.delta*P.f2*y(3) ;
    dydt(4) = P.p * P.alpha * y(2) - P.f1 * ylag1(4) - P.r1 * y(4) - P.mu * y(4) - P.delta * P.f1 * y(4);
...
function dydt = ddefun_pre2(t, y, Z)
    ...
    dydt(1) = P.b - P.beta * (1 - P.epsilon * P.phi) * y(1) * (P.sigma * y(3) + y(4)) - P.mu * y(1);
    dydt(2) = P.beta * (1 - P.epsilon * P.phi) * y(1) * (P.sigma * y(3) + y(4)) - P.alpha * y(2) - P.mu * y(2);
    dydt(3) = (1 - P.p) * P.alpha * y(2) + P.f2 * ylag2(3) - P.r2 * y(3) - P.mu * y(3) - P.delta*P.f2*y(3) ;
    dydt(4) = P.p * P.alpha * y(2) - P.r1 * y(4) - P.mu * y(4) - P.delta * P.f1 * y(4);
